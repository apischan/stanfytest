...
public class CandidateRepositoryImpl implements CandidateRepository {
    ...
    public CandidateDto getCandidateById(int id) {
        try (Connection connection = connectionProvider.getConnection()) {
            ...
            Map<CandidateDto, List<String>> result = query
                    .fetch()
                    .stream()
                    .collect(groupingBy(
                            r -> {
                            ...
                            mapping(r -> r.getValue(SKILL.NAME, String.class), toList())
                    ));
    ...
    private Stream<CandidateDto> convertToCandidateDto(Map<CandidateDto, List<String>> result) {
        Set<Map.Entry<CandidateDto, List<String>>> entries = result.entrySet();
